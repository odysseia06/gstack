...
REPORT_DIR="${GSTACK_WORKSPACE_DIR:-$HOME/.ai-workspace/$REPO}/benchmark-reports"
...
Write to `$REPORT_DIR/baselines/baseline.json`.
...
Write to `$REPORT_DIR/{date}-benchmark.md` and `$REPORT_DIR/{date}-benchmark.json`.
